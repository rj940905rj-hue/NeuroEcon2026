...
\begin{frame}{Photos of dmPFC and example of CaMKII-positive glutamatergic neurons and mDLX-positive GABAergic neurons}
  \begin{column}
    \includegraphics{figures/fig.1a.jpg}
    \includegraphics{figures/fig.1c.jpg}
  \end{column}
\end{frame}
