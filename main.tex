...
\begin{columns}[T]
  ...
  \begin{column}{0.42\textwidth}
    \includegraphics[width=\linewidth]{cell counts.png}
  \end{column}
\end{columns}
\papersource
\end{frame}

\begin{frame}{Photos of dmPFC and the example of CaMKII-positive glutamatergic neurons and mDLX-positive GABAergic neurons}
  \begin{column}{0.25\textwidth}
    \includegraphics[width=\linewidth]{fig.1a.jpg}
  \end{column}
  \begin{column}{0.3\textwidth}
    \includegraphics[width=\linewidth]{fig.1c.jpg}
  \end{column}
  \begin{column}{0.3\textwidth}
   \includegraphics[width=\linewidth]{fig.1d.jpg}  
  \end{column}
\end{frame}
...
\begin{columns}[T]
  ...
  \begin{column}{0.41\textwidth}
    ...
    \begin{tikzpicture}[>=Latex, scale=0.82]
      \draw[rounded corners, fill=softblue] (-0.5,0) rectangle (2.3,3.2);
      \draw[rounded corners, fill=softred] (4.3,0) rectangle (7.1,3.2);
      \draw[thick, accentblue, ->] (0,0.7) -- (1.8,2.7);
      \draw[thick, accentred, ->] (4.8,0.7) -- (6.6,2.7);
      \draw[very thick, accentgold, ->] (2.5,2.7) -- (4.3,2.7);
      \node at (0.9,3.45) {\scriptsize Mouse 1 neural space};
      \node at (5.5,3.45) {\scriptsize Mouse 2 neural space};
      \node[align=center] at (3.3,2.7) {\scriptsize max shared\\ \scriptsize covariance};
      \node[align=center] at (1.3,0.35) {\scriptsize unique};
      \node[align=center] at (5.9,0.35) {\scriptsize unique};
    \end{tikzpicture}
    \end{center}
  \end{column}
\end{columns}
...
\begin{columns}[T]
  \begin{column}{0.50\textwidth}
    \includegraphics[width=\linewidth]{fig.1p.jpg}
  \end{column}
  \begin{column}{0.46\textwidth}
    \begin{itemize}
...
\begin{columns}[T]
  \begin{column}{0.52\textwidth}
    \includegraphics[width=\linewidth]{fig.1q-t.jpg}
  \end{column}
  \begin{column}{0.42\textwidth}
...
\begin{columns}[T]
  ...
  \begin{column}{0.50\textwidth}
    ...
    \begin{tikzpicture}[>=Latex, scale=0.6, transform shape]
      \node[draw, rounded corners, fill=softblue, minimum width=2.45cm, minimum height=1.0cm] (all) {All GABA units};
      \node[draw, rounded corners, fill=softred, below left=2.5cm and 0.15cm of all, minimum width=2.45cm, minimum height=1.0cm] (social) {remove social-responsive};
      \node[draw, rounded corners, fill=softgray, below right=2.5cm and 0.01cm of all, minimum width=2.45cm, minimum height=1.0cm] (nonsocial) {remove non-social-responsive};
...
\begin{columns}[T]
  \begin{column}{0.48\textwidth}
    \includegraphics[width=0.84\linewidth]{fig.2n.jpg}
  \end{column}
  \begin{column}{0.46\textwidth}
    \begin{itemize}
...
\begin{columns}[T]
  \begin{column}{0.35\textwidth}
    \includegraphics[width=\linewidth]{fig.2o.jpg}
  \end{column}
  \begin{column}{0.42\textwidth}
    \begin{itemize}
...
\begin{columns}[T]
  ...
  \end{column}
  \begin{column}{0.46\textwidth}
    \includegraphics[width=\linewidth]{shared_unique_variance.png}
  \end{column}
\end{columns}
\vspace{0.1em}
...
\begin{columns}[T]
  \begin{column}{0.25\textwidth}
    \includegraphics[width=\linewidth]{fig.4f.jpg}
  \end{column}
  \begin{column}{0.25\textwidth}
    \includegraphics[width=\linewidth]{fig.extand-12a.jpg}
  \end{column}
  \begin{column}{0.46\textwidth}
    \begin{itemize}
...
\begin{columns}[T]
  \begin{column}{0.52\textwidth}
    ...
    \begin{tikzpicture}[>=Latex, node distance=1.0cm, scale=0.9, transform shape]
      ...
      \node[draw, rounded corners, fill=softblue, right=2.1cm of a, minimum width=2.55cm, minimum height=1.05cm] (b) {Mouse B: escape};
...
\begin{columns}[T]
  ...
  \end{column}
  \begin{column}{0.40\textwidth}
    \includegraphics[width=\linewidth]{ai_emergence.png}
  \end{column}
\end{columns}
\vspace{0.1em}
...
\begin{columns}[T]
  \begin{column}{0.50\textwidth}
    \includegraphics[width=\linewidth]{shared dimensions in agents.png}
  \end{column}
...
\begin{columns}[T]
  ...
  \begin{column}{0.45\textwidth}
    \includegraphics[width=\linewidth]{ai_decoding.png}
  \end{column}
\end{columns}
\end{frame}
...
\begin{columns}[T]
  ...
  \end{column}
  \begin{column}{0.46\textwidth}
    \includegraphics[width=0.9\linewidth]{ai_perturbation.png}
  \end{column}
\end{columns}
\vspace{0.2em}
...
\begin{frame}{Photos of showing of active, social and non-social behaviors}
\begin{column}{0.65\textwidth}
  \includegraphics[width=\linewidth]{fig.1e-g.jpg}
\end{column}
\end{frame}
